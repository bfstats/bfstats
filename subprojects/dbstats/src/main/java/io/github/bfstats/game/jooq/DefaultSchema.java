...
public class DefaultSchema extends SchemaImpl {
    ...
    private static final long serialVersionUID = -1726400837;
     ...
     */
    public final Player PLAYER = io.github.bfstats.game.jooq.tables.Player.PLAYER;

    /**
     * The table <code>player_nickname</code>.
     */
    public final PlayerNickname PLAYER_NICKNAME = io.github.bfstats.game.jooq.tables.PlayerNickname.PLAYER_NICKNAME;

    /**
     * The table <code>player_rank</code>.
     */
    public final PlayerRank PLAYER_RANK = io.github.bfstats.game.jooq.tables.PlayerRank.PLAYER_RANK;

    /**
     * The table <code>round</code>.
     */
    public final Round ROUND = io.github.bfstats.game.jooq.tables.Round.ROUND;

    /**
     * The table <code>round_chat_log</code>.
     */
    public final RoundChatLog ROUND_CHAT_LOG = io.github.bfstats.game.jooq.tables.RoundChatLog.ROUND_CHAT_LOG;

    /**
     * The table <code>round_end_stats</code>.
     */
    public final RoundEndStats ROUND_END_STATS = io.github.bfstats.game.jooq.tables.RoundEndStats.ROUND_END_STATS;

    /**
     * The table <code>round_end_stats_player</code>.
     */
    public final RoundEndStatsPlayer ROUND_END_STATS_PLAYER = io.github.bfstats.game.jooq.tables.RoundEndStatsPlayer.ROUND_END_STATS_PLAYER;

    /**
     * The table <code>round_player</code>.
     */
    public final RoundPlayer ROUND_PLAYER = io.github.bfstats.game.jooq.tables.RoundPlayer.ROUND_PLAYER;

    /**
     * The table <code>round_player_death</code>.
     */
    public final RoundPlayerDeath ROUND_PLAYER_DEATH = io.github.bfstats.game.jooq.tables.RoundPlayerDeath.ROUND_PLAYER_DEATH;

    /**
     * The table <code>round_player_medpack</code>.
     */
    public final RoundPlayerMedpack ROUND_PLAYER_MEDPACK = io.github.bfstats.game.jooq.tables.RoundPlayerMedpack.ROUND_PLAYER_MEDPACK;

    /**
     * The table <code>round_player_pickup_kit</code>.
     */
    public final RoundPlayerPickupKit ROUND_PLAYER_PICKUP_KIT = io.github.bfstats.game.jooq.tables.RoundPlayerPickupKit.ROUND_PLAYER_PICKUP_KIT;

    /**
     * The table <code>round_player_repair</code>.
     */
    public final RoundPlayerRepair ROUND_PLAYER_REPAIR = io.github.bfstats.game.jooq.tables.RoundPlayerRepair.ROUND_PLAYER_REPAIR;

    /**
     * The table <code>round_player_score_event</code>.
     */
    public final RoundPlayerScoreEvent ROUND_PLAYER_SCORE_EVENT = io.github.bfstats.game.jooq.tables.RoundPlayerScoreEvent.ROUND_PLAYER_SCORE_EVENT;

    /**
     * The table <code>round_player_team</code>.
     */
    public final RoundPlayerTeam ROUND_PLAYER_TEAM = io.github.bfstats.game.jooq.tables.RoundPlayerTeam.ROUND_PLAYER_TEAM;
