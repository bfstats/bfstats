...
public class ServerRecord extends UpdatableRecordImpl<ServerRecord> implements Record6<Integer, String, Integer, String, String, String> {

    private static final long serialVersionUID = -876890708;
    ...
    /**
     * Setter for <code>server.last_parsed_datetime</code>.
     */
    ...
    /**
     * Getter for <code>server.last_parsed_datetime</code>.
     */
    ...
    public Field<String> field6() {
        return Server.SERVER.LAST_PARSED_DATETIME;
    }
     ...
     */
    @Override
    public ServerRecord values(Integer value1, String value2, Integer value3, String value4, String value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ServerRecord(Integer id, String ip, Integer port, String name, String timezoneName, String lastParsedDatetime) {
        super(Server.SERVER);
