...
public class RoundPlayerScoreEventRecord extends UpdatableRecordImpl<RoundPlayerScoreEventRecord> implements Record10<Integer, Integer, Integer, BigDecimal, BigDecimal, BigDecimal, Timestamp, String, Integer, String> {

    private static final long serialVersionUID = 630163035;
     ...
     */
    @Override
    public Row10<Integer, Integer, Integer, BigDecimal, BigDecimal, BigDecimal, Timestamp, String, Integer, String> fieldsRow() {
     ...
     */
    @Override
    public Row10<Integer, Integer, Integer, BigDecimal, BigDecimal, BigDecimal, Timestamp, String, Integer, String> valuesRow() {
     ...
     */
    @Override
    public RoundPlayerScoreEventRecord values(Integer value1, Integer value2, Integer value3, BigDecimal value4, BigDecimal value5, BigDecimal value6, Timestamp value7, String value8, Integer value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RoundPlayerScoreEventRecord(Integer id, Integer roundId, Integer playerId, BigDecimal playerLocationX, BigDecimal playerLocationY, BigDecimal playerLocationZ, Timestamp eventTime, String scoreType, Integer victimId, String weapon) {
        super(RoundPlayerScoreEvent.ROUND_PLAYER_SCORE_EVENT);
