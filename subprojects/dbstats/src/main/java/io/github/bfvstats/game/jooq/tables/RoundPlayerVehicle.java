...
public class RoundPlayerVehicle extends TableImpl<RoundPlayerVehicleRecord> {
    ...
    private static final long serialVersionUID = 2093270694;
     ...
     */
    public final TableField<RoundPlayerVehicleRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER, this, "");
     ...
     */
    public final TableField<RoundPlayerVehicleRecord, BigDecimal> PLAYER_LOCATION_X = createField("player_location_x", org.jooq.impl.SQLDataType.NUMERIC.precision(4, 4).nullable(false), this, "");

    /**
     * The column <code>round_player_vehicle.player_location_y</code>.
     */
    public final TableField<RoundPlayerVehicleRecord, BigDecimal> PLAYER_LOCATION_Y = createField("player_location_y", org.jooq.impl.SQLDataType.NUMERIC.precision(4, 4).nullable(false), this, "");

    /**
     * The column <code>round_player_vehicle.player_location_z</code>.
     */
    public final TableField<RoundPlayerVehicleRecord, BigDecimal> PLAYER_LOCATION_Z = createField("player_location_z", org.jooq.impl.SQLDataType.NUMERIC.precision(4, 4).nullable(false), this, "");
     ...
     */
    public final TableField<RoundPlayerVehicleRecord, String> VEHICLE = createField("vehicle", org.jooq.impl.SQLDataType.VARCHAR.length(50), this, "");

    /**
     * Create a <code>round_player_vehicle</code> table reference
     */
    public RoundPlayerVehicle() {
        this("round_player_vehicle", null);
    }
    ...
    private RoundPlayerVehicle(String alias, Table<RoundPlayerVehicleRecord> aliased) {
        this(alias, aliased, null);
    }

    private RoundPlayerVehicle(String alias, Table<RoundPlayerVehicleRecord> aliased, Field<?>[] parameters) {
