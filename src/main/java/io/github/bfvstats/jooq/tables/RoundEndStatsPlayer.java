...
public class RoundEndStatsPlayer extends TableImpl<RoundEndStatsPlayerRecord> {
    ...
    private static final long serialVersionUID = 1870419819;
     ...
     */
    public final TableField<RoundEndStatsPlayerRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    public RoundEndStatsPlayer() {
        this("round_end_stats_player", null);
    }
    ...
    private RoundEndStatsPlayer(String alias, Table<RoundEndStatsPlayerRecord> aliased) {
        this(alias, aliased, null);
    }

    private RoundEndStatsPlayer(String alias, Table<RoundEndStatsPlayerRecord> aliased, Field<?>[] parameters) {
